...
def main():
    ...
    # Step 2: Preprocessing
    min_mean = float(input("Enter the minimum mean for highly variable genes: "))
    max_mean = float(input("Enter the maximum mean for highly variable genes: "))
    adata = preprocessing(extracted_file_path, min_mean, max_mean, images_dir)

    # # Step 3: PCA
    
    n_pcs = int(input("Enter the number of principal components for PCA: "))
    adata =run_pca(adata, n_pcs, images_dir)
    
    # # Step 4: Computing and embedding neighbourhood graphs
    num_pcs= int(input("Enter the number of PCA to use for Computing and embedding neighbourhood graphs: "))
    num_neighbours= int(input("Enter the number of neighbours to use for Computing and embedding neighbourhood graphs: "))
    adata= computing_and_embedding_neighbourhood_graphs(adata, num_neighbours,num_pcs,images_dir)
    ...
    num_genes = int(input("Enter the number of genes for finding marker genes: "))
    method  = input("Enter the method name: ")
